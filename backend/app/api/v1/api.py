...
from app.api.v1.endpoints import (
    ...
    # pos  # Temporarily disabled due to import issues
)
...
# api_router.include_router(pos.router, prefix="/pos", tags=["point-of-sale"])  # Temporarily disabled
...
api_router.include_router(analytics_simple.router, prefix="/analytics", tags=["analytics-simple"])
