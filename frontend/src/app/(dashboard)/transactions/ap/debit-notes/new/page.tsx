...
export default function NewDebitNotePage() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold text-gray-900 mb-8">New Debit Note (Return)</h1>
      <p className="text-gray-600 mb-8">
        Create a debit note for returns or adjustments to supplier accounts.
      </p>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div>
          ...
          <input
            type="text"
            {...register('reference')}
            placeholder="e.g., Return authorization number"
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
          />
        </div>
        ...
        <div className="flex gap-4">
          ...
          >
            {isSubmitting || createMutation.isPending ? 'Creating...' : 'Create Debit Note'}
          </button>
          <button
            type="button"
