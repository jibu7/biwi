...
export default function NewSupplierPage() {
  ...
  const createMutation = useMutation({
    mutationFn: apService.createSupplier,
    onSuccess: () => {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold text-gray-900 mb-8">Create New Supplier</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex gap-4">
          ...
          >
            {isSubmitting || createMutation.isPending ? 'Creating...' : 'Create Supplier'}
          </button>
          <button
            type="button"
