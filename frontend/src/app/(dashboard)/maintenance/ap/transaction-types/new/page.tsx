...
export default function NewAPTransactionTypePage() {
  ...
  const {
    ...
    defaultValues: {
      ...
      default_ap_control_gl_account_id: null,
    },
  });

  const createMutation = useMutation({
    mutationFn: apService.createAPTransactionType,
    onSuccess: () => {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-bold text-gray-900 mb-8">Create New AP Transaction Type</h1>
