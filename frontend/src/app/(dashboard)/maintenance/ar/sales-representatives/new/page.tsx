...
export default function NewSalesRepresentativePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (data: SalesRepFormData) => {
      ...
      return salesRepService.create(submitData);
    },
    onSuccess: () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">You don't have permission to create sales representatives.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 py-6">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Add Sales Representative</h1>
            <p className="text-gray-600 mt-1">Create a new sales representative record</p>
          </div>
          <button
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
            ...
            {createMutation.error && (
              <div className="bg-red-50 border border-red-200 rounded-md p-4">
                <p className="text-sm text-red-600">
                  Failed to create sales representative. Please try again.
                </p>
              </div>
            )}
            ...
            <div className="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
              ...
              >
                ...
                {isSubmitting || createMutation.isPending ? 'Creating...' : 'Create Sales Representative'}
              </button>
            </div>
          </form>
        </div>
